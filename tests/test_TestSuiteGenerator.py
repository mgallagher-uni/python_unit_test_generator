...
@pytest.fixture
def generator():
	return TestSuiteGenerator('mock_src')
...
def test_generate_suite(mock_src_generated, generator):
	...
	assert os.path.isfile("test_mock_src\\test_model.py") and os.path.isfile("test_mock_src\\lib\\test_queue.py") and os.path.isfile("conftest.py")
